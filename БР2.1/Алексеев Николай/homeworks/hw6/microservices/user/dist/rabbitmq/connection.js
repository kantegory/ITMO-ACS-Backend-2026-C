...
async function connectRabbitMQ() {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            await ch.assertExchange(exports.EXCHANGES.USER, 'topic', {
                durable: true,
            });
            await ch.assertExchange(exports.EXCHANGES.RECIPE, 'topic', {
                durable: true,
            });
            await ch.assertExchange(exports.EXCHANGES.ENGAGEMENT, 'topic', {
                durable: true,
            });
            channel = ch;
            ...
            console.error(`RabbitMQ connection failed (attempt ${attempt}/${maxRetries})`, error);
