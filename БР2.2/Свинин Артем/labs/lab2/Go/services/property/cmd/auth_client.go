...
func (s *propertyService) authenticate(w http.ResponseWriter, r *http.Request) (principal, bool) {
	...
	return principal{UserID: validation.UserID, Role: validation.Role, Email: validation.Email}, true
}

func canManageProperty(p principal, ownerID int64) bool {
	return p.UserID == ownerID || strings.EqualFold(p.Role, "ADMIN")
}
