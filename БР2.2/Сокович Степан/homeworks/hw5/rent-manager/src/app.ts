...
import { initKafkaRpcClient } from "./kafka-rpc-client";
import { startKafkaRpcServer } from "./kafka-rpc";
...
class App {
  ...
  public async start(): Promise<void> {
    ...
    await retry(async () => initKafkaRpcClient());
    await retry(async () => startKafkaRpcServer());
