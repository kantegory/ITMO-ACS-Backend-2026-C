...
const kafka_rpc_1 = require("./kafka-rpc");
class App {
    ...
    async start() {
        ...
        await (0, retry_1.retry)(async () => (0, kafka_rpc_client_1.initKafkaRpcClient)());
        await (0, retry_1.retry)(async () => (0, kafka_rpc_1.startKafkaRpcServer)());
